...
const About = () => {
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("ahmadeb911@gmail.com");
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
          ...
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                Currently studying software engineering at Latakia University.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container">
            ...
            <div>
              ...
              <p className="grid-subtext">
                I specialize in React.js and Next.js utilizing modern technology
                tools.
              </p>
            </div>
          </div>
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container">
            ...
            />
            <div className="grid-headtext">My passion for coding</div>
            <div className="grid-subtext">
              I love solving problems and building awesome things through code.
            </div>
          </div>
        </div>
            ...
            <div className="space-y-2">
              ...
              <p className="copy-container" onClick={handleCopy}>
                <img
                  ...
                  alt="copy"
                />
                <span className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">
                  ahmadeb911@gmail.com
                </span>
              </p>
            </div>
          </div>
